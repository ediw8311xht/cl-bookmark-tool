...
5.  Removing/ Modifying bookmarks with urls that no longer exist or return error (e.g. 403, 404, 500)

#### In Progress:

1.  Binary Releases (order of importance: linux, mac, windows)
2.  Extracting/pushing using browser database directly
